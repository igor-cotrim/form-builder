...
function FormSubmitComponent({
      ...
      <div className="flex items-center justify-center w-full p-8">
        <div className="max-w-[620px] flex flex-col gap-4 flex-grow bg-background w-full p-8 overflow-y-auto border shadow-xl shadow-blue-700 rounded-md">
          ...
          <p className="text-muted-foreground">
            Thank you for sybmitting the form, you can close this page now.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex items-center justify-center w-full h-full p-8">
      <div
        key={renderKey}
        className="max-w-[620px] flex flex-col gap-4 flex-grow bg-background w-full p-8 overflow-y-auto border shadow-xl shadow-blue-700 rounded-md"
      >
        {content.map((element) => {
